/*
** $Id: cfe_time.h 1.5 2011/11/30 15:10:46EST jmdagost Exp  $
**
...
**            parameters are set to TRUE.  The first is #CFE_TIME_SERVER which defines 
...
** \par Assumptions, External Events, and Notes:
**          - This routine is included in the API only when 3 specific configuration 
**            parameters are set to TRUE.  The first is #CFE_TIME_SERVER which defines this 
